        ...
        <div class=row>
          ...
          <div class='col-md-5 single-recipe-topRow'>
            ...
            <p class='random-recipe-div'>
              <div class="col-sm-6" ><img src='images/recipeasy-icons-logos/knife-fork.png' style='margin-right:1.5%' alt='clock icon' height='35' width='35'><strong>Servings:</strong>
              <strong id="servings"></strong></div>
              

              <div class="col-sm-6" ><img src='images/recipeasy-icons-logos/clock.png' style='margin-right:1.5%' alt='clock icon' height='30' width='30'><strong>Cooking Time: </strong>
              <strong id="time"></strong></div>
              

              <div class="col-sm-6" ><img src='images/recipeasy-icons-logos/cuisine.png' style='margin-right:1.5%' alt='clock icon' height='30' width='30'><strong>Cuisine: </strong>
              <strong id="cuisine"></strong></div>
              

              <div class="col-sm-6" ><img src='images/recipeasy-icons-logos/utensils.png' style='margin-right:1.5%' alt='clock icon' height='40' width='40'><strong>Equipment: </strong>
