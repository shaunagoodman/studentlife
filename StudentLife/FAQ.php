                ...
                <div class="col-lg-12 accordion-section ">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card faq-card">
                            <div class="card-header" id="headingFour">
                                <h5 class="mb-0">
                                    <button class="btn btn-link stretched-link" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseOne">
                                    <i class="fas fa-utensils"></i> What is the Random Recipe Generator?
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                                <div class="card-body">
                                    <p class="faq-p" > The Random Recipe Generator is a section of the website you can use when you're not sure what to cook! 
                                    <br> It will generate a random recipe from our extensive database, and the possibilities are endless! <br>
                                    If you see one you like, you can then add it to your favourites using the "favourite" button underneath the recipe!</p>
                                </div>
                            </div>
                        </div>
